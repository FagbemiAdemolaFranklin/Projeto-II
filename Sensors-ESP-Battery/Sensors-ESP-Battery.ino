...
/*PINS USED AUTOMATICALLY (BY DEFAULT)

By the default, the light intensity sensor uses the pin 21  for SDA and pin 22 for SCL
Therefore, these pins hould be reserved for their utilization
...
void loop() {
  ...
  float luminousity = read_luminousity_value();
  ...
  delay(2000);  // Send every 3 seconds
}
